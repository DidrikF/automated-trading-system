...
from automated_trading_system.multiprocessing.engine import pandas_mp_engine, split_df_into_molecules
...
def test_pandas_mp_engine():
    ...
    time10 = time.time()
    touches1 = pandas_mp_engine(
        barrier_touch,
        atoms=normal_draws,
        molecule_key="normal_draws",
        num_processes=8,
