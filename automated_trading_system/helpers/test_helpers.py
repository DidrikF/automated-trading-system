...
from automated_trading_system.helpers.helpers import get_acceptable_dates, get_row_with_closest_date
from automated_trading_system.helpers.helpers import get_most_up_to_date_10k_filing, get_most_up_to_date_10q_filing, \
...
def setup():
    ...
    sf1_art = pd.read_csv("../../datasets/testing/sf1_art.csv",
                          parse_dates=["datekey", "calendardate", "reportperiod"],
                          index_col="calendardate")

    sf1_arq = pd.read_csv("../../datasets/testing/sf1_arq.csv",
                          parse_dates=["datekey", "calendardate", "reportperiod"],
                          index_col="calendardate")
...
def test_get_most_up_to_date_10k_filing():
    ...
    caldate_2012_06_30 = pd.to_datetime(
        "2012-06-30")  # (10K one year earlier (for 2011-06-30) has a correction released 2011-11-14)
...
def test_get_most_up_to_date_10q_filing():
    ...
    assert get_most_up_to_date_10q_filing(sf1_arq_ntk, caldate_2012_03_31, datekey_2012_05_10, 0)[
               "datekey"] == datekey_2012_05_10
...
def test_get_calendardate_index():
    ...
    desired = [pd.to_datetime("2012-06-30"), pd.to_datetime("2012-09-30"), pd.to_datetime("2012-12-31"),
               pd.to_datetime("2013-03-31"), pd.to_datetime("2013-06-30"), pd.to_datetime("2013-09-30")]
...
def test_forward_fill_gaps():
    sf1_lacking = pd.read_csv("../../datasets/testing/lacking_sf1_art.csv",
                              parse_dates=["datekey", "calendardate", "reportperiod"], index_col="calendardate")
