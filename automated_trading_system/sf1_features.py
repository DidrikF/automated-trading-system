...
from automated_trading_system.helpers.helpers import get_most_up_to_date_10k_filing, \
    get_most_up_to_date_10q_filing, forward_fill_gaps, \
    get_calendardate_x_quarters_later
...
def add_sf1_features(sf1_art: pd.DataFrame, sf1_arq: pd.DataFrame, metadata: pd.DataFrame):
    ...
    for index_cur, art_row_cur in sf1_art.iterrows():
        ...
        art_row_1y_ago = get_most_up_to_date_10k_filing(sf1_art, caldate_cur, datekey_cur,
                                                        1)  # How is this working as I am comparing a data to a numerical index????
        ...
        if sf1_arq_empty == False:
            ...
            if (not arq_row_cur_empty) and (not arq_row_4q_ago_empty):
                ...
                if arq_row_cur["marketcap"] != 0:
                    sf1_art.at[index_cur, "rsup"] = (arq_row_cur["revenueusd"] - arq_row_4q_ago["revenueusd"]) / \
                                                    arq_row_cur["marketcap"]

                # Earnings Surprise (sue), Formula: (SF1[netinc]q-1 - SF1[netinc]q-5) / SF1[marketcap]q-1
                if arq_row_cur["marketcap"] != 0:
                    sf1_art.at[index_cur, "sue"] = (arq_row_cur["netinc"] - arq_row_4q_ago["netinc"]) / arq_row_cur[
                        "marketcap"]
            ...
            if (not arq_row_cur_empty) and (not arq_row_1q_ago_empty) and (not arq_row_2q_ago_empty) and \
                ...
                if arq_row_1q_ago["revenueusd"] != 0:
                    chppne_sales_q_1 = (arq_row_1q_ago["ppnenet"] - arq_row_2q_ago["ppnenet"]) / arq_row_1q_ago[
                        "revenueusd"]
                else:
                    chppne_sales_q_1 = (arq_row_1q_ago["ppnenet"] - arq_row_2q_ago["ppnenet"]) * 0.01

                if arq_row_2q_ago["revenueusd"] != 0:
                    chppne_sales_q_2 = (arq_row_2q_ago["ppnenet"] - arq_row_3q_ago["ppnenet"]) / arq_row_2q_ago[
                        "revenueusd"]
                else:
                    chppne_sales_q_2 = (arq_row_2q_ago["ppnenet"] - arq_row_3q_ago["ppnenet"]) * 0.01

                if arq_row_3q_ago["revenueusd"] != 0:
                    chppne_sales_q_3 = (arq_row_3q_ago["ppnenet"] - arq_row_4q_ago["ppnenet"]) / arq_row_3q_ago[
                        "revenueusd"]
                else:
                    chppne_sales_q_3 = (arq_row_3q_ago["ppnenet"] - arq_row_4q_ago["ppnenet"]) * 0.01

                sf1_art.at[index_cur, "cinvest"] = chppne_sales_cur - (
                            (chppne_sales_q_1 + chppne_sales_q_2 + chppne_sales_q_3) / 3)
        ...
        if art_row_cur["cashneq"] != 0:
            sf1_art.at[index_cur, "cashpr"] = (art_row_cur["marketcap"] + art_row_cur["debtnc"] - art_row_cur[
                "assets"]) / art_row_cur["cashneq"]
        ...
        if (art_row_cur["liabilitiesc"] != 0):
            sf1_art.at[index_cur, "quick"] = (art_row_cur["assetsc"] - art_row_cur["inventory"]) / art_row_cur[
                "liabilitiesc"]
        ...
        if (art_row_cur["equity"] + art_row_cur["liabilities"] + art_row_cur["cashneq"] - art_row_cur[
            "investmentsc"]) != 0:
            ...
            sf1_art.at[index_cur, "roic"] = (art_row_cur["ebit"] - nopic_t_1) / (
                        art_row_cur["equity"] + art_row_cur["liabilities"] + art_row_cur["cashneq"] - art_row_cur[
                    "investmentsc"])
        ...
        if industry_cur in ["Beverages - Brewers", "Beverages - Wineries & Distilleries", "Gambling",
                            "Tobacco"]:  # "Electronic Gaming & Multimedia"
        ...
        if art_row_cur["assets"] != 0:
            sf1_art.at[index_cur, "tang"] = (art_row_cur["cashnequsd"] + 0.715 * art_row_cur["receivables"] + 0.547 *
                                             art_row_cur["inventory"] + 0.535 * art_row_cur["ppnenet"]) / art_row_cur[
                                                "assets"]
        ...
        if art_row_cur["marketcap"] != 0:
            sf1_art.at[index_cur, "eqt_marketcap"] = (art_row_cur["equityusd"] - art_row_cur["intangibles"]) / \
                                                     art_row_cur["marketcap"]
        ...
        if not art_row_1y_ago_empty:
            ...
            if (art_row_cur["liabilities"] - art_row_1y_ago["liabilities"]) != 0:
                sf1_art.at[index_cur, "cashdebt"] = (art_row_cur["revenueusd"] + art_row_cur["depamor"]) / (
                            (art_row_cur["liabilities"] - art_row_1y_ago["liabilities"]) / 2)
            ...
            if art_row_cur["assetsavg"] != 0:
                sf1_art.at[index_cur, "chinv"] = (art_row_cur["inventory"] - art_row_1y_ago["inventory"]) / art_row_cur[
                    "assetsavg"]
            ...
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "gma"] = (art_row_cur["revenueusd"] - art_row_cur["cor"]) / art_row_1y_ago[
                    "assets"]
            ...
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "invest"] = ((art_row_cur["ppnenet"] - art_row_1y_ago["ppnenet"]) + (
                            art_row_cur["inventory"] - art_row_1y_ago["inventory"])) / art_row_1y_ago["assets"]
            ...
            if art_row_1y_ago["equityusd"] != 0:
                sf1_art.at[index_cur, "operprof"] = (art_row_cur["revenueusd"] - art_row_cur["cor"] - art_row_cur[
                    "sgna"] - art_row_cur["intexp"]) / art_row_1y_ago["equityusd"]
            ...
            if (art_row_cur["liabilitiesc"] != 0) and (art_row_1y_ago["liabilitiesc"] != 0) and (
                    art_row_1y_ago["assetsc"] != 0):
                sf1_art.at[index_cur, "pchcurrat"] = ((art_row_cur["assetsc"] / art_row_cur["liabilitiesc"]) / (
                            art_row_1y_ago["assetsc"] / art_row_1y_ago["liabilitiesc"])) - 1
            ...
            if (art_row_cur["ppnenet"] != 0) and (art_row_1y_ago["ppnenet"] != 0) and (art_row_1y_ago["depamor"] != 0):
                sf1_art.at[index_cur, "pchdepr"] = ((art_row_cur["depamor"] / art_row_cur["ppnenet"]) / (
                            art_row_1y_ago["depamor"] / art_row_1y_ago["ppnenet"])) - 1
            ...
            if (art_row_cur["revenueusd"] != 0) and (art_row_1y_ago["revenueusd"] != 0):
                ...
                if gross_margin_t_2 != 0:
                    sf1_art.at[index_cur, "pchgm_pchsale"] = ((gross_margin_t_1 / gross_margin_t_2) - 1) - (
                                (art_row_cur["revenueusd"] / art_row_1y_ago["revenueusd"]) - 1)
            ...
            if (art_row_cur["liabilitiesc"] != 0) and (art_row_1y_ago["liabilitiesc"] != 0):
                ...
                quick_ratio_1y_ago = (art_row_1y_ago["assetsc"] - art_row_1y_ago["inventory"]) / art_row_1y_ago[
                    "liabilitiesc"]
            ...
            if (art_row_1y_ago["revenueusd"] != 0) and (art_row_1y_ago["inventory"] != 0):
                sf1_art.at[index_cur, "pchsale_pchinvt"] = ((art_row_cur["revenueusd"] / art_row_1y_ago[
                    "revenueusd"]) - 1) - ((art_row_cur["inventory"] / art_row_1y_ago["inventory"]) - 1)
            ...
            if (art_row_1y_ago["revenueusd"] != 0) and (art_row_1y_ago["receivables"] != 0):
                sf1_art.at[index_cur, "pchsale_pchrect"] = ((art_row_cur["revenueusd"] / art_row_1y_ago[
                    "revenueusd"]) - 1) - ((art_row_cur["receivables"] / art_row_1y_ago["receivables"]) - 1)
            ...
            if (art_row_1y_ago["revenueusd"] != 0) and (art_row_1y_ago["sgna"] != 0):
                sf1_art.at[index_cur, "pchsale_pchxsga"] = ((art_row_cur["revenueusd"] / art_row_1y_ago[
                    "revenueusd"]) - 1) - ((art_row_cur["sgna"] / art_row_1y_ago["sgna"]) - 1)

            # % change sales-to-inventory (pchsaleinv), Formula: ((SF1[revenueusd]t-1 / SF1[inventory]t-1) / (SF1[revenueusd]t-2 / SF1[inventory]t-2)) - 1
            if (art_row_cur["inventory"] != 0) and (art_row_1y_ago["inventory"] != 0) and (
                    art_row_1y_ago["revenueusd"] != 0):
                sf1_art.at[index_cur, "pchsaleinv"] = ((art_row_cur["revenueusd"] / art_row_cur["inventory"]) / (
                            art_row_1y_ago["revenueusd"] / art_row_1y_ago["inventory"])) - 1
            ...
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "chtl_lagat"] = (art_row_cur["liabilities"] - art_row_1y_ago["liabilities"]) / \
                                                      art_row_1y_ago["assets"]

            # ΔLT/LAGICAPT (chlt_laginvcap), Formula: (SF1[liabilities]t-1 - SF1[liabilities]t-2) / SF1[invcap]t-2
            if art_row_1y_ago["invcap"] != 0:
                sf1_art.at[index_cur, "chlt_laginvcap"] = (art_row_cur["liabilities"] - art_row_1y_ago["liabilities"]) / \
                                                          art_row_1y_ago["invcap"]

            # ΔLCT/LAGAT (chlct_lagat), Formula: (SF1[liabilitiesc]t-1 - SF1[liabilitiesc]t-2) / SF1[assets]t-2
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "chlct_lagat"] = (art_row_cur["liabilitiesc"] - art_row_1y_ago["liabilitiesc"]) / \
                                                       art_row_1y_ago["assets"]

            # ΔXINT/LAGAT	(chint_lagat), Formula: (SF1[intexp]t-1  - SF1[intexp]t-2)/SF1[assets]t-2
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "chint_lagat"] = (art_row_cur["intexp"] - art_row_1y_ago["intexp"]) / \
                                                       art_row_1y_ago["assets"]

            # ΔINVT/LAGSALE (chinvt_lagsale), Formula: (SF1[inventory]t-1 - SF1[inventory]t-2) / SF1[revenueusd]t-2
            if art_row_1y_ago["revenueusd"] != 0:
                sf1_art.at[index_cur, "chinvt_lagsale"] = (art_row_cur["inventory"] - art_row_1y_ago["inventory"]) / \
                                                          art_row_1y_ago["revenueusd"]

            # ΔXINT/LAGXSGA (chint_lagsgna), Formula: (SF1[intexp]t-1  - SF1[intexp]t-2) / SF1[sgna]t-2
            if art_row_1y_ago["sgna"] != 0:
                sf1_art.at[index_cur, "chint_lagsgna"] = (art_row_cur["intexp"] - art_row_1y_ago["intexp"]) / \
                                                         art_row_1y_ago["sgna"]

            # ΔLCT/LAGICAPT (chltc_laginvcap), Formula: (SF1[liabilitiesc]t-1 - SF1[liabilitiesc]t-2) / SF1[invcap]t-2
            if art_row_1y_ago["invcap"] != 0:
                sf1_art.at[index_cur, "chltc_laginvcap"] = (art_row_cur["liabilitiesc"] - art_row_1y_ago[
                    "liabilitiesc"]) / art_row_1y_ago["invcap"]

            # ΔXINT/LAGLT	(chint_laglt), Formula: (SF1[intexp]t-1  - SF1[intexp]t-2) / SF1[liabilities]t-2
            if art_row_1y_ago["liabilities"] != 0:
                sf1_art.at[index_cur, "chint_laglt"] = (art_row_cur["intexp"] - art_row_1y_ago["intexp"]) / \
                                                       art_row_1y_ago["liabilities"]

            # ΔDLTT/LAGAT (chdebtnc_lagat), Formula: (SF1[debtnc]t-1 - SF1[debtnc]t-2) / SF1[assets]t-2
            if art_row_1y_ago["assets"] != 0:
                sf1_art.at[index_cur, "chdebtnc_lagat"] = (art_row_cur["debtnc"] - art_row_1y_ago["debtnc"]) / \
                                                          art_row_1y_ago["assets"]

            # ΔINVT/LAGCOGS (chinvt_lagcor), Formula:	(SF1[inventory]t-1 - SF1[inventory]t-2) / SF1[cor]t-2
            if art_row_1y_ago["cor"] != 0:
                sf1_art.at[index_cur, "chinvt_lagcor"] = (art_row_cur["inventory"] - art_row_1y_ago["inventory"]) / \
                                                         art_row_1y_ago["cor"]

            # ΔPPENT/LAGLT (chppne_laglt), Formula: (SF1[ppnenet]t-1 - SF1[ppnenet]t-2) / SF1[liabilities]t-2
            if art_row_1y_ago["liabilities"] != 0:
                sf1_art.at[index_cur, "chppne_laglt"] = (art_row_cur["ppnenet"] - art_row_1y_ago["ppnenet"]) / \
                                                        art_row_1y_ago["liabilities"]

            # ΔAP/LAGACT (chpay_lagact), Formula: (SF1[payables]t-1 - SF1[payables]t-2) / SF1[assetsc]t-2
            if art_row_1y_ago["assetsc"] != 0:
                sf1_art.at[index_cur, "chpay_lagact"] = (art_row_cur["payables"] - art_row_1y_ago["payables"]) / \
                                                        art_row_1y_ago["assetsc"]

            # ΔXINT/LAGICAPT (chint_laginvcap), Formula: (SF1[intexp]t-1 - SF1[intexp]t-2) / SF1[invcap]t-2
            if art_row_1y_ago["invcap"] != 0:
                sf1_art.at[index_cur, "chint_laginvcap"] = (art_row_cur["intexp"] - art_row_1y_ago["intexp"]) / \
                                                           art_row_1y_ago["invcap"]

            #  ΔINVT/LAGACT (chinvt_lagact), Formula:	(SF1[inventory]t-1 - SF1[inventory]t-2) / SF1[assetsc]t-2
            if art_row_1y_ago["assetsc"] != 0:
                sf1_art.at[index_cur, "chinvt_lagact"] = (art_row_cur["inventory"] - art_row_1y_ago["inventory"]) / \
                                                         art_row_1y_ago["assetsc"]
            ...
            if art_row_cur["ppnenet"] != 0:
                sf1_art.at[index_cur, "chdebtnc_ppne"] = (art_row_cur["debtnc"] - art_row_1y_ago["debtnc"]) / \
                                                         art_row_cur["ppnenet"]

            # NP/SALE	(chdebtc_sale), Formula: (SF1[debtc]t-1 - SF1[debtc]t-2) / SF1[revenueusd]t-1
            if art_row_cur["revenueusd"] != 0:
                sf1_art.at[index_cur, "chdebtc_sale"] = (art_row_cur["debtc"] - art_row_1y_ago["debtc"]) / art_row_cur[
                    "revenueusd"]
        ...
        if not art_row_1y_ago_empty:
            ...
            if (art_row_cur["revenueusd"] != 0) and (art_row_1y_ago["revenueusd"] != 0):
                sf1_art.at[index_cur, "chprofitmargin"] = (art_row_cur["netinc"] - art_row_cur["revenueusd"]) - (
                            art_row_1y_ago["netinc"] / art_row_1y_ago["revenueusd"])
...
def get_ps(art_row_cur, art_row_1y_ago):
    ...
    if (art_row_cur["assetsavg"] != 0) and (art_row_1y_ago["assetsavg"] != 0) and (art_row_cur["liabilitiesc"] != 0) \
            and (art_row_1y_ago["liabilitiesc"] != 0) and (art_row_cur["revenueusd"] != 0) and (
            art_row_1y_ago["revenueusd"] != 0):
        ...
        i5_lower_long_term_debt_to_assets = 1 if ((art_row_cur["debtnc"] / art_row_cur["assetsavg"]) < (
                    art_row_1y_ago["debtnc"] / art_row_1y_ago["assetsavg"])) else 0

        i6_higher_current_ratio = 1 if ((art_row_cur["assetsc"] / art_row_cur["liabilitiesc"]) > (
                    art_row_1y_ago["assetsc"] / art_row_1y_ago["liabilitiesc"])) else 0

        i7_no_new_shares = 1 if (art_row_cur["sharesbas"] <= art_row_1y_ago["sharesbas"]) else 0

        i8_higher_gross_margin = 1 if (
                    ((art_row_cur["revenueusd"] - art_row_cur["cor"]) / art_row_cur["revenueusd"]) > (
                        (art_row_1y_ago["revenueusd"] - art_row_1y_ago["cor"]) / art_row_1y_ago["revenueusd"])) else 0

        i9_higher_asset_turnover_ratio = 1 if ((art_row_cur["revenueusd"] / art_row_cur["assetsavg"]) > (
                    art_row_1y_ago["revenueusd"] / art_row_1y_ago["assetsavg"])) else 0
...
if __name__ == "__main__":
    ...
    sf1_art_featured = pandas_mp_engine(callback=add_sf1_features, atoms=sf1_art, \
                                        data={"sf1_arq": sf1_arq, 'metadata': metadata}, molecule_key='sf1_art',
