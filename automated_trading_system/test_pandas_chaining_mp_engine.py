...
sep_tasks = [
    ...
    # Name of molecules saved as pickle in cache_dir, as csv file in save_dir or dict in molecules_dict
    },
    {
    ...
    },
    {
        ...
        "save_result_to_disk": False,
        "cache_result": True,
        "add_to_molecules_dict": True,
    # Config used if some task later than the one immediately following needes this task's output
...
def test_cache_completed_tasks():
    ...
    sep_featured = pandas_chaining_mp_engine(tasks=sep_tasks, primary_atoms="sep", atoms_configs=atoms_configs, \
                                             split_strategy="ticker", num_processes=num_processes, cache_dir=cache_dir,
                                             save_dir=save_dir, sort_by=["ticker", "date"], \
...
def test_resume_from_cache():
    ...
    sep_featured = pandas_chaining_mp_engine(tasks=sep_tasks_not_caching_all, primary_atoms="sep",
                                             atoms_configs=atoms_configs, \
                                             split_strategy="ticker", num_processes=num_processes, cache_dir=cache_dir,
                                             save_dir=save_dir, sort_by=["ticker", "date"], \
    ...
    sep_featured_2 = pandas_chaining_mp_engine(tasks=sep_tasks_not_caching_all, primary_atoms="sep",
                                               atoms_configs=atoms_configs, \
