...
# from automated_trading_system.backtester.strategy import BuyAppleStrategy
from automated_trading_system.backtester.portfolio import Portfolio
from automated_trading_system.backtester.utils import EquityCommissionModel, EquitySlippageModel
from automated_trading_system.backtester.visualization.visualization import plot_data
...
def test_backtester():
    ...
    def handle_data(bt):  # perf, port, md, cur_date
        ...
        bt.perf.at[bt.market_data.cur_date, "AAPL"] = bt.market_data.current_for_ticker("AAPL")[
            "close"]  # Shuold succeed allways
