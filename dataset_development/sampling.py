...
Traceback (most recent call last):
  ...
  File "/home/ubuntu/pycode/automated-trading-system/packages/processing/engine.py", line 255, in process_jobs_fast
    for out_ in outputs:
  File "/home/ubuntu/anaconda3/envs/master/lib/python3.6/processing/pool.py", line 735, in next
    raise value
TypeError: unsupported operand type(s) for -: 'Timestamp' and 'NoneType'
"""