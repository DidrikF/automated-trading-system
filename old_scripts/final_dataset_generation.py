...
if __name__ == "__main__":
    ...
    save_path = "./datasets/ml_ready_old/dataset_" + timestamp
    read_path = "./datasets/ml_ready_old/dataset_20190327-153153"
    ...
    if calculate_features == True:
        sep = pd.read_csv("./datasets/sharadar/SHARADAR_SEP.csv", parse_dates=["date"], index_col="date", low_memory=False)
        
        sf1_art = pd.read_csv("./datasets/sharadar/SHARADAR_SF1_ART.csv", parse_dates=["calendardate", "datekey", "reportperiod"],\
            index_col="calendardate", low_memory=False)
        
        sf1_arq = pd.read_csv("./datasets/sharadar/SHARADAR_SF1_ARQ.csv", parse_dates=["calendardate", "datekey", "reportperiod"],\
            index_col="calendardate", low_memory=False)
        ...
        if sampling == True:
            ...
            # It takes for ever to split up into jobs.
            ...
            sep_extended = pd.read_csv(read_path + "/sep_extended.csv", parse_dates=["date"], index_col="date")
